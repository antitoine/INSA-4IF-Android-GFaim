...
public class AlarmSettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.alarm_settings, null);
        ExpandableListView elv = (ExpandableListView) v.findViewById(R.id.list);
        elv.setAdapter(new AlarmSettingsAdapter());
        return v;
    }

    public class AlarmSettingsAdapter extends BaseExpandableListAdapter {
